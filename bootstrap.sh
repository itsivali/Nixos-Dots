...
echo ""
echo -e "  ${BOLD}Package testing (free or unfree — no rebuild needed):${RESET}"
echo -e "    nix-shell ${REPO_DIR}/testing.nix                    — drop into test shell"
echo -e "    NIXPKGS_ALLOW_UNFREE=1 nix-shell -p <pkg> --impure  — quick one-liner"
echo ""
